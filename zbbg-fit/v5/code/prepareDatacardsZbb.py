...
## Gaussian resolution
zg_gmean = ROOT.RooRealVar("zg_gmean","zg_gmean",zjet_gmean.getVal(),zjet_gmean.getVal()-5,zjet_gmean.getVal()+5)
zg_gsigmaL = ROOT.RooRealVar("zg_gsigmaL","zg_gsigmaL",zjet_gsigmaL.getVal(),zjet_gsigmaL.getVal()*0.5,zjet_gsigmaL.getVal()*2.)
zg_gsigmaR = ROOT.RooRealVar("zg_gsigmaR","zg_gsigmaR",zjet_gsigmaR.getVal(),zjet_gsigmaR.getVal()*0.5,zjet_gsigmaR.getVal()*2.)
